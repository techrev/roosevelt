    ...
    return new Promise((resolve, reject) => {
      ...
      function spawnNewValidator () {
        ...
        validatorProcess.stdout.on('data', (data) => {
          // logger.verbose(`htmlValidator line 106 data from stdout is ${data}`)
    ...
    if (params.htmlValidator.separateProcess.enable && params.htmlValidator.separateProcess.autoKiller) {
      ...
      if (test === true) {
        ...
        fkill(PID, { force: true, tree: false }).then((msg) => {
          logger.verbose(`in htmlValidator line 461, resolve from fkill promise has value of ${msg}`)
          ...
          logger.verbose(`in htmlValidator line 469, reject from fkill promise has value of ${msg}`)
